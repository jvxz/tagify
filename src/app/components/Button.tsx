...
const button = tv({
  extend: focusRing,
  base: "px-4 py-2 font-semibold tracking-wide text-center transition rounded-md border  shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] cursor-default",
  variants: {
    variant: {
      primary:
        "bg-primary hover:bg-primary/80 pressed:bg-primary/90 text-white",
      secondary:
